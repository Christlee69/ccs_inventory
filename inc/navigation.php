  ...
  <?php
    ...
    define('ROOT_URL', 'http://localhost/ccs_inventory/');
?>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
      <div class="container">
      	<img id="top" src="images/Loginlogo.png" style="border-radius:10px; margin-right: 10px; width: 60px; height:60px;"/> 
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
            <li><a href="admin-only.php"><img src="./images/Administrator.png" width="40px" height="40px"></a></li>
          </li>
          </ul>
        </div>
      </div>
